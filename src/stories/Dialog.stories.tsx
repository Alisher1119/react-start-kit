...
export const Open: Story = {
  render: () => (
    <Dialog defaultOpen>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Opened by Default</DialogTitle>
          <DialogDescription>
            This dialog is open when the story loads.
          </DialogDescription>
        </DialogHeader>
        <p>This helps in testing the content coverage.</p>
      </DialogContent>
    </Dialog>
  ),
};
